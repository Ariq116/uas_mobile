...
public class MainHistory extends AppCompatActivity implements OrderHistoryAdapter.OnUploadClickListener {
    ...
    private void uploadBuktiTransfer(Uri fileUri) {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                Toast.makeText(MainHistory.this, "Upload berhasil", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(MainHistory.this, "Upload gagal: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
